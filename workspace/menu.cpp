    ...
    cin >> menuSelection; //get user selection;
      ...
      switch (menuSelection){
        ...
        case '3':
          ...
          break;
        case '0':
        //I wanted to keep the 0 option as the universal 'back' command just because it seems more intuitive.
...
void genericSubmenu(){//submenu created to test main menu and 'back' functionality
  char menuSelection;
